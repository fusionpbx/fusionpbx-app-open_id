			...
			<div id='default_login'>
				...
				<form method='post' name='frm' action=''>
					...
					<div>
						...
						{/if}
						{if isset($button_google) && $button_google}
						<div style="display: flex; align-items: center; gap: 10px;">
							<hr style="flex: 1; border: none; border-top: 1px solid #ccc;">
								<span style="font-size: 0.8em; color: #666;">or</span>
							<hr style="flex: 1; border: none; border-top: 1px solid #ccc;">
						</div>
						<a class='login_openid_provider' style='display: inline-block; margin-top: 15px;' href='{$project_path}/resources/login.php?action=openid_google'>
							<img src='data:image/png;base64,{$google_svg}' alt='Sign-in With Google'/>
						</a><br />
						{/if}
					</div>
				</form>
